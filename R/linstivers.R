#' Lin and Stivers' MLE based test
#'
#' Calculates Lin and Stivers' MLE based test statistic and corresponding p-value for partially matched samples.
#'
...
#'
#' @examples
#' linstivers(hetNA[,1],hetNA[,2],alternative="two.sided")
#' 
#' @export

linstivers = function(x,y,alternative=c("two.sided","less","greater")){
  ...
  V1 = ((f^2/n1 + (1-f)^2/n2)*ST1^2*(n1-1)+(g^2/n1+(1-g)^2/n3)*SN1^2*(n1-1)-2*f*g*STN1*(n1-1)/n1)/(n1-1)
